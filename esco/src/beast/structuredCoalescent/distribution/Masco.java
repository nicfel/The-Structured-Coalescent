...
import beast.structuredCoalescent.math.ode_masco;
...
public class Masco extends StructuredTreeDistribution implements Loggable {
    ...
    public double calculateLogP() {
        ...
        do {
        	...
        	if (duration > 0) {
                ...
                // set the odes
                FirstOrderDifferentialEquations ode = new ode_masco(migration_rates, coalescent_rates, nr_lineages , states);
                // integrate	                
...
//    	System.out.println("");
		...
		if (nr_lineages>0)
			return Math.log(interval/nr_lineages);
		else
			return 0;
